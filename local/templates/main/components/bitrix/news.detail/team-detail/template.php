						...
						<div class="img-box-hover">
							<ul>
								<?if($arResult["PROPERTIES"]["link_Vk"]["VALUE"]):?>
									<li><a href="<?=$arResult["PROPERTIES"]["link_Vk"]["VALUE"];?>"><i class="fab fa-vk"></i></a></li>
								<?endif;?>

								<?if($arResult["PROPERTIES"]["link_Instagram"]["VALUE"]):?>
									<li><a href="<?=$arResult["PROPERTIES"]["link_Instagram"]["VALUE"];?>"><i class="fab fa-instagram"></i></a></li>
								<?endif;?>

								<?if($arResult["PROPERTIES"]["link_Facebook"]["VALUE"]):?>
									<li><a href="<?=$arResult["PROPERTIES"]["link_Facebook"]["VALUE"];?>"><i class="fab fa-facebook-f"></i></a></li>
								<?endif;?>

								<?if($arResult["PROPERTIES"]["link_Twitter"]["VALUE"]):?>
									<li><a href="<?=$arResult["PROPERTIES"]["link_Twitter"]["VALUE"];?>"><i class="fab fa-twitter"></i></a></li>
								<?endif;?>

								<?if($arResult["PROPERTIES"]["link_Youtube"]["VALUE"]):?>
									<li><a href="<?=$arResult["PROPERTIES"]["link_Youtube"]["VALUE"];?>"><i class="fab fa-youtube"></i></a></li>
								<?endif;?>
							</ul>
						</div>
					</div>
